...
import createThemeImport, { type CreateThemeOptions } from '@uiw/codemirror-themes';
import { tags as t } from '@lezer/highlight';

const defaultDemoCode = `console.log('TODO: Add syntax highlighting.');`;
type CodeMirrorTheme = Exclude<ReactCodeMirrorProps['theme'], undefined>;
type CreateThemeFn = (options: CreateThemeOptions) => CodeMirrorTheme;
const createThemeInterop: unknown = createThemeImport;
const createTheme: CreateThemeFn =
    (typeof createThemeInterop === 'function'
        ? createThemeInterop
        : (createThemeInterop as { createTheme?: unknown }).createTheme) as CreateThemeFn;

if (typeof createTheme !== 'function') {
    throw new TypeError('Expected @uiw/codemirror-themes to expose a createTheme function.');
}
