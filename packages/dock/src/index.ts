export type {
  ...
  DockPolicyConfig,
  DockReducerAction,
  DockRemovePanelIntent,
  DockResizeSplitIntent,
  DockSplitNode,
  DockState,
  DockStateInit,
  DockFloatRootNode,
  DockFloatWindowNode,
  NormalizeDockOptions,
  Rect,
} from './model';
...
export {
  DOCK_SCHEMA_VERSION,
  applyDockPolicy,
  assertDockInvariants,
  cloneDockState,
  createDockState,
  createDockStateFromPanels,
  createFloatRootNode,
  createFloatWindowNode,
  createGroupNode,
  createPanelNode,
  createSplitNode,
  migrateDockState,
...
export type {
  ...
  DockInteractionControllerOptions,
  DockInteractionIntent,
  DockResizeStartOptions,
} from './interaction';
...
export {
  createDockFocusQuery,
  createDockLayoutQuery,
  createDockPanelQuery,
} from './queries';

export type {
  DockIntentNames,
  RegisterDockIntentsOptions,
} from './intents';
