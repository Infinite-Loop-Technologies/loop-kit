import { computeDropOverlay, rectToStyle, type DockDropTarget } from './geometry';
...
export function describeDropOverlay(target: DockDropTarget | null): DockDebugOverlay | null {
...
export function applyOverlayRect(element: HTMLElement, target: DockDropTarget | null): void {
