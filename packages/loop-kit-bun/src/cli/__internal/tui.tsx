...
export function idx(w: number, x: number, y: number) {
    return y * w + x;
}
export function clearCanvas(c: ReturnType<typeof makeCanvas>) {
    c.data.fill(0);
}

export type Tool = 'ink' | 'erase';

export function useTerminalInput(handlers: {
