...
import type { InteractionCapabilities, InteractionRole } from "./InteractionRoles.js"
...
export interface InteractionTargetRegistry {
  readonly register: (registration: InteractionTargetRegistration) => InteractionTarget
  readonly unregister: (targetId: InteractionTargetId) => void
  readonly get: (targetId: InteractionTargetId) => InteractionTarget | undefined
  readonly getAncestry: (targetId: InteractionTargetId) => ReadonlyArray<InteractionTarget>
  readonly resolveFromDomNode: (node: EventTarget | null) => InteractionTarget | undefined
  readonly closestWithRole: (
    targetId: InteractionTargetId,
    role: InteractionRole
  ) => InteractionTarget | undefined
  readonly hasRole: (targetId: InteractionTargetId, role: InteractionRole) => boolean
  readonly clear: () => void
}
