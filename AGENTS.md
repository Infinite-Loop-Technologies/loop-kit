...
- Audience is expert: keep communication terse, actionable, and avoid restating obvious context.
...
- Prefer functional components and composition over inheritance; keep side effects in hooks.
