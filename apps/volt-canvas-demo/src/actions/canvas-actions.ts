export const canvasActionIds = {
  ...
  toggleBrowserDiagnostics: "canvas.browser.diagnostics.toggle",
  toggleBrowserPassthrough: "canvas.browser.passthrough.toggle",
...
export const canvasCommandItems: CanvasCommandItem[] = [
  ...
  {
    actionId: canvasActionIds.toggleBrowserPassthrough,
    description: "Force all embedded browser surfaces into passthrough mode for hit-test debugging.",
    id: "browser-passthrough",
    keywords: ["browser", "passthrough", "debug", "input"],
    shortcut: "Mod+Shift+P",
    title: "Toggle browser passthrough debug",
  },
  {
    actionId: canvasActionIds.toggleBrowserDiagnostics,
    description: "Show or hide the browser diagnostics overlay.",
    id: "browser-diagnostics",
    keywords: ["browser", "diagnostics", "debug", "overlay"],
    shortcut: "Mod+Shift+D",
    title: "Toggle browser diagnostics",
  },
  {
