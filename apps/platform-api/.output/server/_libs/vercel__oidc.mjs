...
var require_get_vercel_oidc_token = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	async function getVercelOidcToken(options) {
		...
		try {
			const [{ getTokenPayload, isExpired }, { refreshToken }] = await Promise.all([await import("./_4.mjs").then((m) => /* @__PURE__ */ __toESM(m.default)), await import("./_7.mjs").then((m) => /* @__PURE__ */ __toESM(m.default))]);
...
//#endregion
//#region ../../node_modules/.bun/@vercel+oidc@3.2.0/node_modules/@vercel/oidc/dist/index.js
