# Moon Dagger Operator Surface

## Outcome

Make Moon the standard trigger surface for Dagger-based agent workflows so humans and agents can run the same named operations with pinned tooling.
...
- Decide how Moon should discover the Dagger automation project, including whether the workspace should start tracking `tools/*`.
...
- Document how Moon queries and task discovery should support the Dagger operator surface.
